...
connection = pymysql.connect(host='localhost',user='root',password='Anwari',db='cv')
...
def run():
    ...
    link = '[Developed by Najibullah Anwari ](https://au.linkedin.com/in/najibullah-anwari-84535b12b)'
    ...
    if choice == 'User':
        ...
        if st.button('Login'):
            if ad_user == 'anwari' and ad_password == 'anwari':
